...
Run <code>pixi r build-ros</code> to build the [synchros2](https://github.com/RAI-Opensource/synchros2) package from source in the <code>humble_ws</code> directory to see an example.
